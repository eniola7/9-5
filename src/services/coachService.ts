...
export const generateCoachResponse = (
  ...
  const templates: Record<string, string> = {
    credit: `${contextLine} Your credit readiness score is ${profile.creditReadinessScore}/100, so the practical move is to keep utilization low and protect on-time payments. Next step: ${nextStep}. Caution: ${caution}`,
